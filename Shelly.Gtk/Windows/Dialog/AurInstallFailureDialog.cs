...
public static class AurInstallFailureDialog
{
        ...
        Func<Task<bool>> exportLogsAsync)
    {
        ...
        var titleLabel = Label.New(T("AUR installation failed"));
        ...
        var descriptionLabel = Label.New(
            T("Shelly couldn't finish building or installing the selected AUR {0}. Export the logs and attach them to your report so the team can check whether the issue came from the PKGBUILD or from Shelly.", packageLabel));
